...
void LCD_Test(void)
{
  ...
  clearTime();
  LCD_PutStr(10, 35, "Hello Jiaqi!", DEFAULT_FONT, C_CYAN, C_BLACK);
  LCD_PutStr(10, 55, "Hello Jiaqi!", DEFAULT_FONT, C_ORANGE_RED, C_BLACK);
  LCD_PutStr(10, 75, "Hello Jiaqi!", DEFAULT_FONT, C_LIME_GREEN, C_BLACK);
  LCD_PutStr(10, 95, "Hello Jiaqi!", DEFAULT_FONT, C_HOT_PINK, C_BLACK);
  UG_Update();
  printTime();
  HAL_Delay(1000);
  ...
  LCD_PutStr(10, 80, "Jiaqi!", FONT_arial_49X57, C_CYAN, C_BLACK);
  UG_Update();
  printTime();
  HAL_Delay(1000);
#endif
